...
namespace CleanArchitecture.Infrastructre
{
    ...
    {
        public static IServiceCollection AddResgistraionDependencies(this IServiceCollection service, IConfiguration configuration)
        {
            ...
            service.AddAuthorization(option =>
            {
                ...
                {
                    policy.RequireClaim("Create New Student", "True");
                });
